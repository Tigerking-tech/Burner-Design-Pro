          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8 text-left">
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link to="/changelog" className="block text-sm hover:text-white transition-colors">Changelog</Link>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link to="/faq" className="block text-sm hover:text-white transition-colors">FAQ / Help</Link>
              </div>
            </div>
            <div>
              <h4 className="text-white font-semibold mb-3 text-sm">Legal</h4>
              <div className="space-y-2">
                <Link to="/privacy-policy" className="block text-sm hover:text-white transition-colors">Privacy Policy</Link>
                <Link to="/terms-of-service" className="block text-sm hover:text-white transition-colors">Terms of Service</Link>
                <Link to="/refund-policy" className="block text-sm hover:text-white transition-colors">Refund Policy</Link>
              </div>
            </div>
            <div>
              <h4 className="text-white font-semibold mb-3 text-sm">Support</h4>
              <div className="space-y-2">
                <Link to="/faq" className="block text-sm hover:text-white transition-colors">Help Center</Link>
                <Link to="/contact" className="block text-sm hover:text-white transition-colors">Contact Us</Link>
                <a href="mailto:support@burnerdesignpro.com" className="block text-sm hover:text-white transition-colors">
