        ...
        <div className="bg-white rounded-lg shadow-xl p-8 border border-gray-300">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <div className="flex items-start gap-3">
              ...
              />
              <label htmlFor="agree-terms" className="text-xs text-[#555] leading-relaxed">
                I agree to the{' '}
                <Link to="/terms" className="text-[#f39c12] hover:text-[#e67e22] font-medium">
                  Terms of Service
                </Link>
                {' '}and{' '}
                <Link to="/privacy-policy" className="text-[#f39c12] hover:text-[#e67e22] font-medium">
                  Privacy Policy
                </Link>
              </label>
            </div>
