...
const nasaCoeffs: Record<string, NasaCoeffs> = {
  ...
  // C₂H₂ (乙炔) - 来源: Cantera gri30
  'C₂H₂': {
    low: { a: [4.14756964, 5.96166664E-03, -2.37294852E-06, 4.67412171E-10, -3.61235213E-14, 2.59359992E+04, -1.23028121] },
    high: { a: [8.08681094E-01, 2.33615629E-02, -3.55171815E-05, 2.80152437E-08, -8.50072974E-12, 2.64289807E+04, 1.39397051E+01] }
  },
  // C₂H₄ (乙烯) - 来源: Cantera gri30
  'C₂H₄': {
    low: { a: [2.03611116, 1.46454151E-02, -6.71077915E-06, 1.47222923E-09, -1.25706061E-13, 4.93988614E+03, 1.03053693E+01] },
    high: { a: [3.95920148, -7.57052247E-03, 5.70990292E-05, -6.91588753E-08, 2.69884373E-11, 5.08977593E+03, 4.09733096] }
  },
  // NH₃ (氨) - 来源: Cantera gri30
  'NH₃': {
    low: { a: [2.6344521, 5.666256E-03, -1.7278676E-06, 2.3867161E-10, -1.2578786E-14, -6.5446958E+03, 6.5662928] },
    high: { a: [4.2860274, -4.660523E-03, 2.1718513E-05, -2.2808887E-08, 8.2638046E-12, -6.7417285E+03, -6.2537277E-01] }
  },
  // H₂S (硫化氢) - 来源: NASA Glenn (nasa_gas.yaml)
  'H₂S': {
    low: { a: [2.7452199, 4.0434607E-03, -1.538451E-06, 2.7520249E-10, -1.8592095E-14, -3.4199444E+03, 8.0546745] },
    high: { a: [3.9323476, -5.0260905E-04, 4.5928473E-06, -3.1807214E-09, 6.6497561E-13, -3.6505359E+03, 2.3157905] }
  },
  // C₆H₆ (苯) - 来源: NASA Glenn (nasa_gas.yaml)
  'C₆H₆': {
    low: { a: [11.0771708, 2.07067895E-02, -7.516251E-06, 1.22209416E-09, -7.35312513E-14, 4.30988395E+03, -4.00116950E+01] },
    high: { a: [5.03469664E-01, 1.85142363E-02, 7.37864409E-05, -1.18106127E-07, 5.07182527E-11, 8.55266293E+03, 2.16481796E+01] }
  },
  // C₃H₆ (丙烯) - 来源: NASA Glenn (nasa_gas.yaml)
  'C₃H₆': {
    low: { a: [6.03870499, 1.62963895E-02, -5.82130624E-06, 9.35936483E-10, -5.58602903E-14, -7.76595092E+02, -8.43824322] },
    high: { a: [3.83464524, 3.29078405E-03, 5.05228184E-05, -6.66251418E-08, 2.63707585E-11, 7.53838295E+02, 7.53410995] }
  },
  // C₄H₈ (1-丁烯) - 来源: NASA Glenn (nasa_gas.yaml)
  'C₄H₈': {
    low: { a: [8.02147991, 2.26010707E-02, -8.31284033E-06, 1.37803072E-09, -8.42175459E-14, -4.30852153E+03, -1.71170697E+01] },
    high: { a: [4.42674073, 6.63946249E-03, 6.80652815E-05, -9.28753562E-08, 3.73473949E-11, -2.11532796E+03, 7.5469486] }
  },
  // C₅H₁₂ (正戊烷) - 来源: NASA Glenn (nasa_gas.yaml)
  'C₅H₁₂': {
    low: { a: [13.546998, 2.8421786E-02, -9.4174648E-06, 1.3893589E-09, -7.4212609E-14, -2.457768E+04, -4.7021175E+01] },
    high: { a: [1.8983679, 4.1203037E-02, 1.2312175E-05, -3.6589501E-08, 1.5042509E-11, -2.00915E+04, 1.8679082E+01] }
  },
  // C₇H₁₆ (正庚烷) - 来源: NASA Glenn (nasa_gas.yaml)
  'C₇H₁₆': {
    low: { a: [18.5354704, 3.91420468E-02, -1.38030268E-05, 2.22403874E-09, -1.3345258E-13, -3.19500783E+04, -7.0190284E+01] },
    high: { a: [11.1532484, -9.49415433E-03, 1.95571181E-04, -2.4975252E-07, 9.84873213E-11, -2.67711735E+04, -1.5909611E+01] }
  },
  // C₆H₁₄ (正己烷) - 来源: NIST Chemistry WebBook 离散数据拟合 (最大Cp误差 <1.2%)
  'C₆H₁₄': {
    low: { a: [-14.73540843, 1.60819903E-01, -2.42440864E-04, 2.27672356E-07, -8.49544996E-11, 2.49945758E+02, 9.17374721E+01] },
    high: { a: [2.329305E-04, 7.13406575E-02, -2.84662523E-05, 3.03642413E-09, 5.26853292E-13, -2.04700704E+03, 2.46975000E+01] }
  }
}
