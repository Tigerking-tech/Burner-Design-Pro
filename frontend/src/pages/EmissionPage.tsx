...
export default function EmissionPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <section className="bg-gradient-to-br from-[#2c3e50] to-[#34495e] dark:from-gray-800 dark:to-gray-900 text-white py-8 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-3">Emission Analysis</h1>
          <p className="text-[#bdc3c7] text-sm md:text-base max-w-2xl mx-auto">
            NOx, CO, SO₂ emission calculations with EPA and EU IED compliance checking.
          </p>
        </div>
      </section>

      <div className="max-w-5xl mx-auto px-3 py-6 sm:px-4 sm:py-8 md:px-5 md:py-10">
        {/* Inline Disclaimer */}
        <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-lg p-3 sm:p-4 flex items-start gap-3 mb-4 sm:mb-6">
        ...
        <div className="bg-white rounded-lg shadow-xl border border-gray-300 p-3 sm:p-4 md:p-6 mb-4 sm:mb-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-[#2c3e50] mb-4 sm:mb-6">Emissions Estimation & Compliance</h2>
          ...
          <div className="flex flex-wrap gap-2 mb-4 sm:mb-6">
            {POLLUTANTS.map((p) => (
              <button
                ...
                className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg font-semibold transition-colors text-sm ${
                  pollutant === p
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
            <div className="bg-gray-100 rounded-lg p-3 sm:p-4 border border-gray-200">
              <h3 className="text-base sm:text-lg font-semibold text-[#2c3e50] mb-3 sm:mb-4">Input Value</h3>
              <div className="space-y-3 sm:space-y-4">
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-[#34495e] mb-1.5 sm:mb-2">
                    {pollutant} Value
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#f39c12] bg-white text-[#2c3e50] text-sm"
                    placeholder="Enter value"
                  />
                </div>
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-[#34495e] mb-1.5 sm:mb-2">Unit</label>
                  <select
                    value={fromUnit}
            ...
            <div className="bg-gray-100 rounded-lg p-3 sm:p-4 border border-gray-200">
              <h3 className="text-base sm:text-lg font-semibold text-[#2c3e50] mb-3 sm:mb-4">O₂ Reference Settings</h3>
              <div className="space-y-3 sm:space-y-4">
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-[#34495e] mb-1.5 sm:mb-2">Measured O₂ (%)</label>
                  <input
                    type="text"
                    value={o2Measured}
                ...
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-[#34495e] mb-1.5 sm:mb-2">Reference O₂ (%)</label>
                  <input
                    type="text"
                    value={o2Reference}
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    className="px-2.5 sm:px-3 py-1 bg-[#f39c12] text-[#2c3e50] rounded hover:bg-[#e67e22] text-xs sm:text-sm font-semibold"
                  >
                    EPA 3%
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="px-2.5 sm:px-3 py-1 bg-[#34495e] text-white rounded hover:bg-[#2c3e50] text-xs sm:text-sm font-semibold"
                  >
                    EU 6%
                  </button>
                </div>
          ...
          <div className="bg-gray-100 rounded-lg p-3 sm:p-4 md:p-6 mb-4 sm:mb-6 border border-gray-200">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 sm:mb-4 gap-2">
              <h3 className="text-base sm:text-lg font-semibold text-[#2c3e50]">Converted Values</h3>
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-[#f39c12] hover:bg-[#e67e22] text-[#2c3e50] rounded-lg transition-colors text-xs sm:text-sm font-semibold w-fit"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 md:gap-4">
              <div className="bg-white rounded-lg p-3 sm:p-4 border border-gray-200">
                <p className="text-xs sm:text-sm text-[#7f8c8d] mb-1">ppm</p>
                <p className="text-lg sm:text-xl md:text-2xl font-bold text-[#2c3e50]">{formatNumber(results.ppm)}</p>
              </div>
              <div className="bg-white rounded-lg p-3 sm:p-4 border border-gray-200">
                <p className="text-xs sm:text-sm text-[#7f8c8d] mb-1">mg/m³</p>
                <p className="text-lg sm:text-xl md:text-2xl font-bold text-[#2c3e50]">{formatNumber(results.mgM3)}</p>
              </div>
              <div className="bg-white rounded-lg p-3 sm:p-4 border border-gray-200">
                <p className="text-xs sm:text-sm text-[#7f8c8d] mb-1">lb/MMBtu</p>
                <p className="text-lg sm:text-xl md:text-2xl font-bold text-[#2c3e50]">{formatNumber(results.lbMMBtu, 4)}</p>
              </div>
            </div>
          </div>

          <div className="bg-gray-100 rounded-lg p-3 sm:p-4 md:p-6 mb-4 sm:mb-6 border border-gray-200">
            <h3 className="text-base sm:text-lg font-semibold text-[#2c3e50] mb-3 sm:mb-4">Compliance Status</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6 mb-2 sm:mb-4">
              <div className="bg-white rounded-lg p-3 sm:p-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 sm:mb-4 gap-2">
                  <h4 className="font-semibold text-[#34495e] text-sm sm:text-base">EPA Standards</h4>
                  <select
                    value={fuelType}
                    onChange={(e) => setFuelType(e.target.value)}
                    className="px-2.5 py-1.5 border border-gray-300 rounded text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#f39c12] bg-white text-[#2c3e50] w-full sm:w-auto"
                  >
                    {FUEL_TYPES.map((f) => (
                ...
                {epaCompliance && (
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center justify-between p-2 sm:p-3 bg-gray-100 rounded border border-gray-200">
                      <span className="text-xs sm:text-sm text-[#34495e]">NOx: {formatNumber(epaCompliance.noxMeasured)} / {epaCompliance.noxLimit} mg/m³</span>
                      <span className={`text-sm ${epaCompliance.noxCompliant ? 'text-green-600' : 'text-red-600'}`}>
                        {epaCompliance.noxCompliant ? '✓' : '✗'}
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-2 sm:p-3 bg-gray-100 rounded border border-gray-200">
                      <span className="text-xs sm:text-sm text-[#34495e]">CO: {formatNumber(epaCompliance.coMeasured)} / {epaCompliance.coLimit} mg/m³</span>
                      <span className={`text-sm ${epaCompliance.coCompliant ? 'text-green-600' : 'text-red-600'}`}>
                        {epaCompliance.coCompliant ? '✓' : '✗'}
                      </span>
                    </div>
                    <div className={`p-2 sm:p-3 rounded text-center font-semibold text-xs sm:text-sm ${epaCompliance.overallCompliant ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-red-100 text-red-800 border border-red-200'}`}>
              ...
              <div className="bg-white rounded-lg p-3 sm:p-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 sm:mb-4 gap-2">
                  <h4 className="font-semibold text-[#34495e] text-sm sm:text-base">EU Standards</h4>
                  <select
                    value={euFuelType}
                ...
                {euCompliance && (
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center justify-between p-2 sm:p-3 bg-gray-100 rounded border border-gray-200">
                      <span className="text-xs sm:text-sm text-[#34495e]">NOx: {formatNumber(euCompliance.noxMeasured)} / {euCompliance.noxLimit} mg/m³</span>
                      <span className={`text-sm ${euCompliance.noxCompliant ? 'text-green-600' : 'text-red-600'}`}>
                        {euCompliance.noxCompliant ? '✓' : '✗'}
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-2 sm:p-3 bg-gray-100 rounded border border-gray-200">
                      <span className="text-xs sm:text-sm text-[#34495e]">CO: {formatNumber(euCompliance.coMeasured)} / {euCompliance.coLimit} mg/m³</span>
                      <span className={`text-sm ${euCompliance.coCompliant ? 'text-green-600' : 'text-red-600'}`}>
                        {euCompliance.coCompliant ? '✓' : '✗'}
                      </span>
                    </div>
                    <div className={`p-2 sm:p-3 rounded text-center font-semibold text-xs sm:text-sm ${euCompliance.overallCompliant ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-red-100 text-red-800 border border-red-200'}`}>
          ...
          <div className="bg-gray-100 rounded-lg p-3 sm:p-4 md:p-6 border border-gray-200">
            <h3 className="text-base sm:text-lg font-semibold text-[#2c3e50] mb-3 sm:mb-4">Annual Emissions Estimation</h3>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4 mb-3 sm:mb-4 md:mb-6">
              <div>
                <label className="block text-xs sm:text-sm font-medium text-[#34495e] mb-1.5 sm:mb-2">NOx (mg/m³)</label>
                <input
                  type="text"
                  value={noxValue}
                  onChange={(e) => handleValueChange(setNoxValue, e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#f39c12] bg-white text-[#2c3e50] text-sm"
                />
              </div>
              <div>
                <label className="block text-xs sm:text-sm font-medium text-[#34495e] mb-1.5 sm:mb-2">CO (mg/m³)</label>
                <input
                  type="text"
                  value={coValue}
              ...
              <div>
                <label className="block text-xs sm:text-sm font-medium text-[#34495e] mb-1.5 sm:mb-2">Flue Gas Flow (m³/h)</label>
                <input
                  type="text"
                  value={flueGasFlow}
              ...
              <div>
                <label className="block text-xs sm:text-sm font-medium text-[#34495e] mb-1.5 sm:mb-2">Annual Hours</label>
                <input
                  type="text"
                  value={annualHours}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 md:gap-4">
              <div className="bg-white rounded-lg p-3 sm:p-4 border border-gray-200">
                <p className="text-xs sm:text-sm text-[#7f8c8d] mb-1">Hourly (kg)</p>
                <p className="text-lg sm:text-xl md:text-2xl font-bold text-[#2c3e50]">{formatNumber(annualEmissions.hourlyKg)}</p>
              </div>
              <div className="bg-white rounded-lg p-3 sm:p-4 border border-gray-200">
                <p className="text-xs sm:text-sm text-[#7f8c8d] mb-1">Annual (tons)</p>
                <p className="text-lg sm:text-xl md:text-2xl font-bold text-[#2c3e50]">{formatNumber(annualEmissions.annualTons)}</p>
              </div>
              <div className="bg-white rounded-lg p-3 sm:p-4 border border-gray-200">
                <p className="text-xs sm:text-sm text-[#7f8c8d] mb-1">Monthly (tons)</p>
                <p className="text-lg sm:text-xl md:text-2xl font-bold text-[#2c3e50]">{formatNumber(annualEmissions.monthlyTons)}</p>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-[#2c3e50] text-[#bdc3c7] text-center py-8 px-4 mt-12 sm:mt-16">
        <div className="flex justify-center gap-4 sm:gap-8 mb-4 sm:mb-5 flex-wrap">
          <Link to="/" className="text-xs sm:text-sm hover:text-white transition-colors">Home</Link>
          <Link to="/unit-converter" className="text-xs sm:text-sm hover:text-white transition-colors">Converter</Link>
          <a href="#privacy" className="text-xs sm:text-sm hover:text-white transition-colors">Privacy Policy</a>
          <a href="#terms" className="text-xs sm:text-sm hover:text-white transition-colors">Terms of Service</a>
        </div>
        <p className="text-xs sm:text-sm text-[#7f8c8d]">© 2026 Burner-Design-Pro. Professional tools for burner engineers.</p>
      </footer>
    </div>
  );
}
